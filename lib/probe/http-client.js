...
class HttpRequestMetrics {
    ...
    onResponse(response) {
        ...
        // ...otherwise don't count actual response size as its streamed & may consume all contents here, ASSETS-4291
    ...
    onEnd() {
        ...
        this.triggerMetrics({
            ...
            ...( typeof this.responseSize!=='undefined' &&  {responseBodySize: this.responseSize} ),
